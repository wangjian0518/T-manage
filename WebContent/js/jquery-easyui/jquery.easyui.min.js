...
function _264(_265,_266,_267,_clickx_obj){
...
win.window({title:_265,noheader:(_265?false:true),width:300,height:"auto",modal:true,collapsible:false,minimizable:false,maximizable:false,resizable:false,onClose:function(){
	if(typeof _clickx_obj != 'undefined' && _clickx_obj.fn_clickx){
		if(!_clickx_obj._isOkRun){
			_clickx_obj.fn_clickx();
		}
	}
setTimeout(function(){
win.window("destroy");
...
return _262(_269);
},alert:function(_26a,msg,icon,fn,fn_clickx){
...
var win=_264(_26a,_26b,_26c, _clickx_obj);
return win;
...
var len=$.trim(_40a).length+$.trim(_40a).replace(/[\u0000-\u00ff]/g,"").length;
